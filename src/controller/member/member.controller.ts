...
import type { MulterFile } from 'src/domain/member/dto/member.dto';
...
export class MemberController {
    ...
    examples: {
      example: {
        value: {
          ...
          memberProfile: 'https://example.com/profile.jpg',
  ...
  async updateProfile(
    ...
    const updatedMember = await this.memberService.updateProfile(
      id,
      thumbnail,
      member,
    );
